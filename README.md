# Mr.Fernando OS – Web Desktop Environment

![Portfolio Screenshot](assets/images/lockscreen.png)
![Portfolio Screenshot](assets/images/homescreen.png)

A modern **web-based desktop environment** that runs directly in the browser.
Mr.Fernando OS recreates the feel of a real operating system with a lockscreen, taskbar, desktop icons, and interactive windows.
Most of the other projects I've built can also be integrated into this website, except for those that are not compatible with the web
...
```bash
git clone https://github.com/PhantomDeluxe-Dev/Portfolio101.git
```
